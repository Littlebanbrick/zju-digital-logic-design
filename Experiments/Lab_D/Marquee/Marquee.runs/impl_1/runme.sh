...
HD_PWD='C:/Users/Littlebanbrick/Desktop/DLD/Experiments/Lab_D/Marquee/Marquee.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Marquee_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Marquee_top.tcl -notrace
