...
HD_PWD='C:/Users/Littlebanbrick/Desktop/DLD/Experiments/Lab_D/Marquee/Marquee.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Marquee_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Marquee_top.tcl
