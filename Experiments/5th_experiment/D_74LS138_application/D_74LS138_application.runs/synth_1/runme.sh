...
HD_PWD='C:/Users/Littlebanbrick/Desktop/DLD/Experiments/5th_experiment/D_74LS138_application/D_74LS138_application.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log application.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source application.tcl
