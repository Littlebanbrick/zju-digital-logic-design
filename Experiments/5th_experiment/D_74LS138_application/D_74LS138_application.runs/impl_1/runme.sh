...
HD_PWD='C:/Users/Littlebanbrick/Desktop/DLD/Experiments/5th_experiment/D_74LS138_application/D_74LS138_application.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log application.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source application.tcl -notrace
