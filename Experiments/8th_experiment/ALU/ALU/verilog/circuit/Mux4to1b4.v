...
module Mux4to1b4( D0,
   ...
   *******************************************************************************/
   assign s_logisimBus44[3:0] = D1;
   assign s_logisimBus45[3:0] = D0;
   assign s_logisimBus46[3:0] = D3;
   ...
   *******************************************************************************/
   ...
   // NOT Gate
   assign s_logisimNet5 = ~s_logisimBus49[1];

   // NOT Gate
   assign s_logisimNet19 = ~s_logisimBus49[0];

   /*******************************************************************************
   ** Here all normal components are defined                                     **
   *******************************************************************************/
   AND_GATE #(.BubblesMask(2'b00))
      GATES_1 (.input1(s_logisimBus49[0]),
   ...
   AND_GATE #(.BubblesMask(2'b00))
      GATES_5 (.input1(s_logisimBus49[0]),
