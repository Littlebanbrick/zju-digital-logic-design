...
HD_PWD='C:/Users/Littlebanbrick/Desktop/DLD/Experiments/6th_experiment/mc14495/mc14495.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DispNum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DispNum.tcl
