...
HD_PWD='C:/Users/Littlebanbrick/Desktop/DLD/Experiments/6th_experiment/mc14495/mc14495.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DispNum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DispNum.tcl -notrace
